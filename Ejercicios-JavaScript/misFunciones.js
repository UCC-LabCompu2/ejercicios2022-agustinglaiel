...
function dibujarImagen (posX, posY)
{
    ...
    console.log(posX, posY); //esto es solo para seguir en consola, no es necesario
    var img = new Image();
    img.src="images/auto.png";

    canvas.width = canvas.width; //para que se dibuje un auto nuevo cada vez que cambiamos valores y no se pisen
    img.onload = function ()
    {
